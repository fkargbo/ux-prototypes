...
/**
 * When the user scrolls OLS observe page content at the top, hide/show the nav banner scroller first
 * (scroll-snap on the banner; snap back when page scroll returns to top).
 */
