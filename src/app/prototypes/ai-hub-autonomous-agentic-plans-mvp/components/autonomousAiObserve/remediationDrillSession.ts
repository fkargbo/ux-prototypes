...
export const REMEDIATION_DRILL_SESSION_KEY =
  'hpux.ai-hub-autonomous-agentic-plans-mvp.remediation-drill-rule';

export const REMEDIATION_DRILL_EVENT = 'hpux.ai-hub-autonomous-agentic-plans-mvp.remediation-drill';
