...
import {
  ...
  type PlanRow,
} from '../ai-hub-v1/PlansAndApprovalsTab';
...
} from '../v1PlanRemediationDrillSession';
import { resolvePlanDomainAnnotations } from '../ai-hub-v1/domainPlanNavigation';
...
export const TroubleshootingPlanDetailV1: React.FC = () => {
