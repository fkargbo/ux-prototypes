/**
 * V1 frozen baseline — session-storage handoff utilities for remediation drill navigation.
 * Uses v1-scoped path constants (/v1/ai-hub/observe/).
 */
...
} from './v1PerspectiveUrl';

export const PLAN_REMEDIATION_DRILL_SESSION_KEY =
  'hpux.ai-hub-autonomous-agentic-plans-mvp.v1.plan-remediation-drill';
