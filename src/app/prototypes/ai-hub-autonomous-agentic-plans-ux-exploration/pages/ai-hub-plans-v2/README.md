...
- If you still see v2 UI after a default change, clear session storage for `hpux.bannerVersion.ai-hub-autonomous-agentic-plans-mvp` or pick **v3.0** once in the picker.
