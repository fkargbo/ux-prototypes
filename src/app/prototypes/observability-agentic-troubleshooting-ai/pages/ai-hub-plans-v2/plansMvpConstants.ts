...
export const PLAN_TOKEN_BURN: Record<string, PlanTokenBurn> = {
  ...
  'inv-gitops-agentit': { analysis: 430 },
  'inv-gitops-pulse-agent': { analysis: 415 },
  'inv-gitops-pulse-ui': { analysis: 405 },
  'inv-pipelines-webhook-listener': { analysis: 440 },
  'inv-pipelines-guestbook-imagepull': { analysis: 425 },
  'inv-pipelines-frontend-tests': { analysis: 410 },
