/**
 * AI Hub chrome that ships only for banner **v2.0** (`prototype.config.bannerVersionPicker`).
 * Edit files here for hub-level v2 work without affecting v1.0 (single `AIHubPage` gates imports).
 */
