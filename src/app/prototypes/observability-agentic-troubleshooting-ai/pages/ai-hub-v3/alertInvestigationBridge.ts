...
export const ALERT_INVESTIGATION_SESSION_KEY =
  'hpux.observability-agentic-troubleshooting-ai.alert-investigation';
...
export const ALERT_INVESTIGATION_EVENT = 'hpux.observability-agentic.alert-investigation';
