          ...
          <Stack hasGutter>
            ...
            <StackItem>
              <Breadcrumb>
                ...
                <BreadcrumbItem to="/core/observe/alerting">Observe</BreadcrumbItem>
                    ...
                    <Flex justifyContent={{ default: 'justifyContentSpaceBetween' }} alignItems={{ default: 'alignItemsCenter' }}>
                      ...
                      <FlexItem>
                        <Flex gap={{ default: 'gapMd' }}>
                          ...
                          <FlexItem>
                            <Button variant="primary" onClick={() => navigate('/core/observe/alerting/create-alert-rule')}>Create a new alert rule</Button>
                          </FlexItem>
                        </Flex>
                      </FlexItem>
                    </Flex>
...
export { MultiClusterAlertingDashboard as SummitFleetAlertingPage };
