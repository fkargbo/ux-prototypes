...
export const CAPABILITY_CARDS_V2_DAY0: CapabilityCardData[] = [
  {
    ...
    title: 'Metrics & Alerting',
    subtitle: 'COO · MonitoringStack',
    status: { kind: 'configuration-required', label: 'Setup required', color: 'grey', srText: 'Status: setup required — MonitoringStack CR not configured' },
    ...
    searchTerms: ['prometheus', 'alertmanager', 'metrics', 'alerting', 'monitoringstack'],
    dependencies: [
      { id: 'monitoring-stack-cr', label: 'COO MonitoringStack CR', state: 'missing', action: { label: 'Configure', href: COO_CR_PATH } },
      { id: 'prometheus',          label: 'Prometheus',             state: 'missing' },
      { id: 'alertmanager',        label: 'Alertmanager',           state: 'missing' },
    ],
    actions: [
      { id: 'configure-monitoring', label: 'Configure', variant: 'secondary', href: COO_CR_PATH, helperText: 'Creates the MonitoringStack CR. Prometheus and Alertmanager are deployed automatically once the CR is active.' },
  ...
  },
  {
    ...
    title: 'Dashboards',
    subtitle: 'COO · Perses',
    status: { kind: 'configuration-required', label: 'Setup required', color: 'grey', srText: 'Status: setup required — Perses UI Plugin CR not enabled' },
    ...
    searchTerms: ['perses', 'dashboards', 'monitoring', 'ui plugin'],
    dependencies: [
      { id: 'monitoring-ui-plugin-cr', label: 'COO Monitoring UI Plugin CR (Perses feature)', state: 'missing', action: { label: 'Enable', href: COO_CR_PATH } },
  ...
  },
  {
    ...
    title: 'Logs',
    subtitle: 'COO · Loki · CLO',
    status: { kind: 'configuration-required', label: 'Setup required', color: 'grey', srText: 'Status: setup required — operators not installed' },
    ...
    searchTerms: ['loki', 'clo', 'logs', 'logging', 'clusterlogforwarder', 'lokistack'],
    dependencies: [
      { id: 'logging-ui-cr',  label: 'COO Logging UI Plugin CR',          state: 'missing', action: { label: 'Enable', href: COO_CR_PATH } },
      { id: 'loki-lokistack', label: 'Loki Operator + LokiStack',         state: 'missing', action: { label: 'Install', href: '/catalog/ns/default?keyword=loki-operator', isExternal: true } },
      { id: 'clo-clf',        label: 'CLO + ClusterLogForwarder',         state: 'missing', action: { label: 'Install', href: '/catalog/ns/default?keyword=cluster-logging', isExternal: true } },
    ],
    actions: [
      { id: 'enable-logging-plugin', label: 'Enable', variant: 'secondary', href: COO_CR_PATH, helperText: 'Enables the Logging UI Plugin CR in COO. Install Loki and CLO operators first, then return here to complete Step 2.' },
  ...
  },
  {
    ...
    searchTerms: ['tempo', 'opentelemetry', 'otel', 'tracing', 'traces', 'tempostack', 'otelcollector'],
    dependencies: [
      { id: 'tracing-ui-cr',    label: 'COO Distributed Tracing UI Plugin CR', state: 'missing', action: { label: 'Enable', href: COO_CR_PATH } },
      { id: 'tempo-tempostack', label: 'Tempo Operator + TempoStack',          state: 'missing', action: { label: 'Install', href: '/catalog/ns/default?keyword=tempo-operator', isExternal: true } },
      { id: 'otel-collector',   label: 'OTEL Operator + OTELCollector',        state: 'missing', action: { label: 'Install', href: '/catalog/ns/default?keyword=opentelemetry-operator', isExternal: true } },
    ],
    actions: [
      { id: 'enable-tracing', label: 'Enable', variant: 'secondary', href: COO_CR_PATH, helperText: 'Enables the Distributed Tracing UI Plugin CR in COO. Install Tempo and OTEL operators first.' },
  ...
  },
  {
    ...
    actions: [
      { id: 'enable-signal-correlation', label: 'Enable', variant: 'secondary', href: COO_CR_PATH, helperText: 'Creates the Troubleshooting Panel UI Plugin CR in COO. The Korrel8r backend is deployed automatically.' },
