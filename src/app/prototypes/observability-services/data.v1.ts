 ...
 *
 * This file is a READ-ONLY snapshot of the Observability services page at v1.0.0.
 * Do NOT edit this file. All new iterations belong in data.ts (v2.0.0+).
 *
 * Differences from v2.0.0:
 *  - 4-card KPI ribbon (Alerts · Operator enablement · Setup action · Operator health)
 *  - Status labels: "Fully enabled" / "Not installed"
 *  - No runtimeHealth / dual-axis operational health label
 *  - No collapsible section badges
 */

import type { CapabilityCardData, KpiPopoverItem, OperationalKpiStat } from './types';

export const OPERATIONAL_KPI_STATS_V1: OperationalKpiStat[] = [
  {
    id: 'alert-posture',
    category: 'Alerts',
    value: '27',
...
export const CAPABILITY_CARDS_V1: CapabilityCardData[] = [
  ...
  },
  {
    ...
    dependencies: [
      { id: 'monitoring-ui-plugin-cr', label: 'COO Monitoring UI Plugin CR (Perses feature)', state: 'ready' },
  ...
  },
  {
    ...
    dependencies: [
      { id: 'logging-ui-cr', label: 'COO Logging UI Plugin CR', state: 'attention', detail: 'Disabled in COO CR' },
