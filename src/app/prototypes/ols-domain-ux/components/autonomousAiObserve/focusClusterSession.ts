...
export const FOCUSED_CLUSTER_SESSION_KEY = 'hpux.ols-domain-ux.focused-cluster-id';

/** Fired after session focus changes so hub chrome (e.g. cluster inventory) stays in sync with the observe widget. */
export const FOCUSED_CLUSTER_CHANGE_EVENT = 'hpux.ols-domain-ux.focused-cluster-change';
