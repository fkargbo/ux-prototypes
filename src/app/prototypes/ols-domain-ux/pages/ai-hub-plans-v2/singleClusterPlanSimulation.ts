...
import { GITOPS_INVESTIGATION_PLAN_IDENTITY } from './gitOpsInvestigationPlans';
import { PIPELINES_INVESTIGATION_PLAN_IDENTITY } from './pipelinesInvestigationPlans';
...
export const SC_PLAN_TABLE_IDENTITY: Record<string, ScPlanTableIdentity> = {
  ...
  cp1: { name: 'ota-5-0-0-ec-4-to-5-1-0', synopsis: 'Upgrade OpenShift 4.14 to 4.15 before channel end of life', namespace: 'openshift-update', fleetCluster: CORE_PLATFORMS_CLUSTER_ID },
  ...
  cp4: { name: 'ota-5-0-0-ec-4-to-5-0-1', synopsis: 'Autonomous cluster health data gathering for update readiness assessment', namespace: 'openshift-update', fleetCluster: CORE_PLATFORMS_CLUSTER_ID },
