...
import { useInvestigationHandoff } from '../../hooks/useInvestigationHandoff';
import {
  Button,
  Content,
  Flex,
...
export const PipelineRunsPage: React.FC = () => {
  const handoffToInvestigation = useInvestigationHandoff();
  ...
  const handleInvestigate = (run: PipelineRun) => {
    ...
    handoffToInvestigation(plan, href);
  };
          ...
          >
            <FlexItem>
              ...
              <Content component="p" className="ols-ai-hub-page-subtitle">
                ...
                Failed runs show <strong>Create AI investigation</strong> when no run exists, or{' '}
                <strong>View AI investigation</strong> when one already exists.
              </Content>
            </FlexItem>
            <FlexItem>
              <Select
